...
Neste repositório consta a implementação de uma estação meteorológica pessoal (PWS) com base na solução [Open Weather Station](https://github.com/panchazo/open-weather-station). A implementação foi adaptada de forma a utilizar uma ESP32 e no contexto da disciplina de Fundamentos de Sistemas Operacionais da UnB-FTCE.
...
* Interface de visualização dos dados em tempo real
...
| **1** | **Módulo Sensor de Chuva**  | **Sinal Digital (DO):** GPIO 18<br>**VCC:** 3.3V (ou 5V)<br>**GND:** GND | Leitura digital (0 ou 1). Placa de detecção de gotas + comparador LM393. Define se está chovendo ou não.                                         |
