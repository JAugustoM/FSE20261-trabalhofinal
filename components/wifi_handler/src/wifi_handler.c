...
void wifi_start(void) {
    ...
    ESP_LOGI(TAG, "Inicialização do WiFi concluída");
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ...
        ESP_LOGE(TAG, "Falha ao conectar ao SSID: %s", WIFI_SSID);
    } else {
        ESP_LOGE(TAG, "Falha inesperada ao conectar ao SSID: %s", WIFI_SSID);
    }
